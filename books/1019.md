...
![](https://cdn.jsdelivr.net/gh/ZanderZhao/img20/file/20191221163438.png)

<center>一个管道-过滤器风格的图示</center>

![](https://cdn.jsdelivr.net/gh/ZanderZhao/img20/file/20191221163545.png)
...
- 通信的目的是传递消息。消息具有不同的形式，例如：符号、文字、语音、音乐、数据、图片、图像等等。因而，根据所传递消息的不同，目前通信业务可以分为电报、电话、传真、数据传输及可视电话等。对于基本的点对点通信，是把发送端的消息传递到接收端。  
  ...
  ![](https://cdn.jsdelivr.net/gh/ZanderZhao/img20/file/20191221163931.png)

- 将上图发送端进一步细分为信息源和发送设备，将接收端细分为接收设备和受信者；同时，在通信过程中会有噪声干扰，在模型中添加噪声源可得到图所示的数字通信系统粗略模型。

  ![](https://cdn.jsdelivr.net/gh/ZanderZhao/img20/file/20191221164019.png)
...
- 在数字通信中存在以下几个突出的问题：
  ...
  ![](https://cdn.jsdelivr.net/gh/ZanderZhao/img20/file/20191221164223.png)
...
![](https://cdn.jsdelivr.net/gh/ZanderZhao/img20/file/20191221164356.png)
...
![](https://cdn.jsdelivr.net/gh/ZanderZhao/img20/file/20191221164549.png)
